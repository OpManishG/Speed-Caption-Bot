...
try: app_id = int(os.environ.get("app_id", "25145421"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "faa6f8032ee368c78522a9fded1c18c6")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "6908772629:AAHokcflamm1o5YMP9LceahAQ0vJDxecg_I")
...
<b>• Source Code : <a href=https://t.me/thespeedmoviess/Speed-AutoCaption-Bot>Click Here</a></b>"""
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="https://t.me/thespeedmoviess"),
...
print("Bot Created By http://t.me/manishraii")
